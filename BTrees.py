...
def read_file(file):
    ...
    os.chdir(r'C:/Users/Eng/Documents/CS/2302/lab4')
    with open(file) as f:
        for i in f:
            english_words.insert(i.strip().lower())
    print("Done")
    return english_words

def count_anagrams(word, english_words):
    counter = print_anagrams(word, english_words)  + 1
   ...
   if len(word) <= 1:
       ...
       for i in range(len(word)):
           ...
           if cur not in before: # Check if permutations of cur have not been generated.
               ...
               #return  print_anagrams(word, english_words) + 1


def main():
  tree = read_file("example.txt")
  tree.draw()
  print_anagrams("llv", tree)
